...
<script>
    ...
    function getDate() {
        ...
        var datumsortName = '';
        if (lcdm == '9401') {
            datumsortName = '预售商品房（预告登记）';
        } else if (lcdm == '9405') {
            datumsortName = '预购商品房抵押权预告登记';
        } else if (lcdm == '9407'){
            datumsortName = '预售商品房预告及预售商品房抵押权预告登记'
        }else if (lcdm == '9403') {
            datumsortName = '其他不动产买卖预告登记';
        } else if (lcdm == '9402') {
            datumsortName = '其他不动产抵押权预告登记';
        } else if (lcdm == '9409'){
            datumsortName = '其它不动产买卖及抵押权预告登记'
        }
        _ajax_get("${contextPath}/file/getDatum?lcdm=${param.lcdm}&yslywh=${param.yslywh}&datumsortName=" + encodeURIComponent(datumsortName), function (result) {
    ...
    function step1() {
        window.location.href = "${contextPath}/front/ygdj/step3?yslywh=${param.yslywh}&lcdm=${param.lcdm}";
    }
    function step3() {
        var guids = '';
...
//        alert(guids);
        ...
        _ajax_post("${contextPath}/front/slsq/saveSlsqDatum", data, function (result) {
            if (result) {
                window.location.href = "${contextPath}/front/ygdj/step5?yslywh=${param.yslywh}&lcdm=${param.lcdm}";
            } else {
                _alert("服务器出错");
            }
        });
