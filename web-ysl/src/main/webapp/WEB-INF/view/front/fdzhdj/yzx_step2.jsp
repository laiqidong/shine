        ...
        if (i > 1) {
            art.dialog({
                ...
                button:[
                    ...
                    {name:"否",
                        callback:function(){
                            window.location.href = '${contextPath}/front/fdzhdj/yzxStep3?dybsms=' + dybsms + '&yslywh=${param.yslywh}&lcdm=${param.lcdm}';
                        }
                    }],
                ...
                if (result.data.blz) {
                    ...
                    _ajax_get('${contextPath}/register/getHouseDetail/' + dybsm, function (result) {
                        if (result.ret == 1) {
                            ...
                            if (lcdm == '2701') {
                                if (ygzt != '3' && ygzt != '4' && ygzt != '5' && ygzt != '6') {
                                    _alert("请选择做过抵押权预告的单元");
                                    return;
                                }
