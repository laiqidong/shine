            ...
            <div class="yhzx_r1">
                    ...
                    <div class="listbox" style="width: 284px;">
                        <ul class="list_ul" id="list_ul">
                            <li class="list">
                                ...
                                <ul>
                                    <li title="国有建设用地使用权及房屋所有权">国有建设用地使用权及房屋所有权</li>
                                    <li title="国有建设用地所有权首次登记国有建设用地所有权首次登记">国有建设用地所有权首次登记国有建设用地所有权首次登记</li>
                                    <li title="海域使用权首次登记">海域使用权首次登记</li>
                                    <li title="抵押权首次登记">抵押权首次登记</li>
                                    <li title="土地承包经营首次登记">土地承包经营首次登记</li>
                                    <li title="房屋所有权首次登记">房屋所有权首次登记</li>
                                    <li title="国有建设用地所有权首次登记">国有建设用地所有权首次登记</li>
                                    <li title="海域使用权首次登记">海域使用权首次登记</li>
                                    <li title="抵押权首次登记">抵押权首次登记</li>
                                    <li title="土地承包经营首次登记">土地承包经营首次登记</li>
                                </ul>
                ...
                <div class="c2" style="margin-left:294px;">
                    <div class="col-xs-12" style="background: #ffffff;padding-top: 10px;min-height:476px">
                        <div class="head">
                            <a class="apply_btn" href="fill_application.html">在线申请</a>
                            <span id="con_title">集体土地所有权首次登记</span>
                        </div>
                        <div class="table_box">
                            <table width="90%" cellspacing="0" cellpadding="0" bordercolor="#DBDBDB">
                                <tr>
                                    <td class="NoNewline"> 适用情形</td>
                                    <td colspan="3">以划拨、出让、租赁、储备、作价出资、授权经营等方式依法取得国有建设用地，国有土地使用权人应当申请国有建设用地使用权首次登记。</td>
                                </tr>
                                <tr>
                                    <td class="NoNewline" >法定时限</td>
                                    <td>30日</td>
                                    <td>承诺时限</td>
                                    <td>30日</td>
                                </tr>
                                <tr>
                                    <td class="NoNewline">资讯电话</td>
                                    <td>0597-3295003</td>
                                    <td>受理机构地址</td>
                                    <td>新罗区龙岩大道1号西附楼市行政服务中心二楼不动产登记窗口</td>
                                </tr>
                                <tr>
                                    <td class="NoNewline" >收费标准</td>
                                    <td colspan="3">登记费每件80，手续费按照不同房屋自然状况收取，<a href="#">详见>></a></td>
                                </tr>
                                <tr>
                                    <td class="NoNewline">收件材料</td>
                                    <td colspan="3">
                                        1、不动产登记申请表（转移登记）。(原件)<br><br>
                                        2、不动产登记证明（抵押预告）。(原件)<br><br>
                                        3、不动产登记证明（预售商品房预告）。(原件)<br><br>
                                        4、抵押合同。(原件)<br><br>
                                        5、抵押物清单。(原件)<br><br>
                                        6、购房发票。(复印件)<br><br>
                                        7、申请人身份证明。(复印件)<br><br>
                                ...
                                <tr>
                                    <!--<td >办理流程</td>-->
                                    <td colspan="4">
                                        <img alt="" src="${contextPath}/resources/ysl_front/images/flowimg/2701-1.png"/>
                                    </td>
                                </tr>
                            </table>
                        </div>
