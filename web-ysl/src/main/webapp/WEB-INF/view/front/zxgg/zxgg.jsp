...
<head>
    ...
    <style type="text/css">
        ...
        .col-xs-12 .head{height: 50px;line-height: 50px;text-align: center;background: #DEEEF6;}
                            ...
                            <%--<li class="list">--%>
                                ...
                                <%--<ul>--%>
                                    <%--<c:forEach items="${title}" var="item">--%>
                                        <%--<li title="${item.infoTitle}" onclick="_content(${item.id})">${item.infoTitle}</li>--%>
                                    <%--</c:forEach>--%>
                                <%--</ul>--%>
                            <%--</li>--%>
                        <%--</ul>--%>
                ...
                <div class="c2" >
                    <div class="col-xs-12" style="background: #ffffff;padding-top: 10px;min-height:476px">
                        <div class="head">
                            ...
                            <span id="con_title" >${t.infoTitle}</span>
                        </div>
...
//        alert(id);
        $.ajax({
            url: "${contextPath}/zxgg/getZxggList/"+id,
            type: "get",
            dataType: "json",
            success: function (result) {
//                var data=;
//                $("#content").html();
//                alert(result.data.t.content);
                $("#content").html(result.data.t.content);
            }
        })
    }
</script>
