                            ...
                            <div id="fixtop" style="z-index: 999;background-color: white;width: 1197px;">
                                ...
                                <c:if test="${param.lcdm=='9405'}">
                                    <div class="col-sm-12">
                                        <h5>
                                            筛选条件：
                                            <input type="checkbox" checked id="ygzt" name="ygzt" value="true"
                                                   onclick="check()">预告&nbsp;
                                        </h5>
                                    </div>
                                </c:if>
                                <div class="col-sm-12">
                                    <h5>
                                        ...
                                        <span><img style="margin-bottom: 3px;"
                                                   src="${contextPath}/resources/ysl_front/images/icon/在建工程抵押.png"
                                                   alt="">在建工程抵押</span>
                                        &nbsp;
                                        <span><img style="margin-bottom: 3px;"
                                        ...
                                        &nbsp;
                                        <span><img style="margin-bottom: 3px;"
                                                   src="${contextPath}/resources/ysl_front/images/icon/抵押权预告登记.png"
                                                   alt="">抵押权预告登记</span>
                                        &nbsp;
                                        <span><img style="margin-bottom: 3px;"
...
<script>
    ...
    function getHouses(zrzbsm) {
        ...
        var url = '${contextPath}/register/getHouses?zrzbsm=' + zrzbsm + '&ygzt=' + ygzt;
        $("#" + zrzbsm).empty();
        _ajax_get(url, function (result) {
            if (result.ret == 1) {
...
//                    icon += '<i class="ace-icon fa fa-bullhorn bigger-120"></i>&nbsp;';
    ...
    function next() {
        ...
        window.location.href = '${contextPath}/front/ygdj/step3?dybsms=' + dybsms + '&yslywh=${param.yslywh}&lcdm='+otherLcdm;
                    ...
                    _ajax_get('${contextPath}/register/getHouseDetail/' + dybsm, function (result) {
                        if (result.ret == 1) {
                            ...
                            if (qszt > 0) {
                                var flag = true;
//                                    _alert("该单元已有产权");
                                _confirm("改单元已有产权，是否走其他类预告登记业务", function () {
                                    isOther = true;
                                    if (lcdm == '9401') {
                                        otherLcdm = '9403';//其他类买卖预告
                                    } else if (lcdm == '9405') {
                                        otherLcdm = '9402';//其他类抵押预告
                                    } else if (lcdm == '9407') {
                                        otherLcdm = '9409';//其他类组合预告
                                    }
                                }, function () {
                                    _tips("正在取消");
                                    flag = false;
